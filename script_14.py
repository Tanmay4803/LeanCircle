# Create data seeding utility (src/utils/seedData.js)
seed_data_content = '''// src/utils/seedData.js - Database seeding utility
...
# Create utils directory and write seedData.js
os.makedirs('src/utils', exist_ok=True)

with open('src/utils/seedData.js', 'w') as f:
...
print("✅ Created src/utils/seedData.js")
print("✅ Created .gitignore")
print("\\n🎉 Backend setup complete! All core files have been created.")